...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.setProperty("https.proxyHost", "https://127.0.0.1:7890");
        ...
        try {
            ...
            while (inFileReader.hasNext()) {
                ...
                if( repoEntry.length > 0 ) {
                    ...
                    // AzureModel.classiffySATD(writer, repoEntry[0] ); // This is to distinguish whether the removed SATD is a refactoring operation, but the Azure API has problems, so it is not used temporarily
