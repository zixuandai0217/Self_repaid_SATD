...
public class RepositoryInitializer {
    ...
    private static final String GIT_USERNAME = "dzx0217";
    private static final String GIT_PASSWORD = "daiZixuan@010217";
...
//    }
	...
	// open git repo locally!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    public boolean initRepo() {
        final File newGitRepo = new File(this.repoDir);
        try {
			//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            // open git repo locally
            this.repoRef = Git.open(newGitRepo);
            this.gitDidInit = true;
        } catch (IOException e) {
            System.err.println("\nCould not open local git repository: " + e.getLocalizedMessage());
            return false;
        }
